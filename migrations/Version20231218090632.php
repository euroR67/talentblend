 ...
 */
final class Version20231218090632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `user` (id INT AUTO_INCREMENT NOT NULL, metier_id INT DEFAULT NULL, niveau_id INT DEFAULT NULL, ville_id INT DEFAULT NULL, messages_envoyes_id INT DEFAULT NULL, messages_recus_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, nom VARCHAR(30) NOT NULL, prenom VARCHAR(30) NOT NULL, pays VARCHAR(30) DEFAULT NULL, photo VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, cv VARCHAR(255) DEFAULT NULL, active TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), INDEX IDX_8D93D649DCF28B17 (metier_id), INDEX IDX_8D93D649B3E9C81 (niveau_id), INDEX IDX_8D93D649286C17BC (ville_id), INDEX IDX_8D93D649D45ED6F3 (messages_envoyes_id), INDEX IDX_8D93D6491C198BD5 (messages_recus_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_8D93D649DCF28B17 FOREIGN KEY (metier_id) REFERENCES metier (id)');
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_8D93D649B3E9C81 FOREIGN KEY (niveau_id) REFERENCES niveau (id)');
        $this->addSql('ALTER TABLE `user` ADD CONSTRAINT FK_8D93D649286C17BC FOREIGN KEY (ville_id) REFERENCES ville (id)');
